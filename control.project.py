# здравствуйте ,меня зовут Пилипенко иван

#НАЗВАНИЕ ПРОЕКТА:
#шифровка и рассшифровка сообщений на языке прогромирования python.
...
if action=="ШИФРОВКА":
    ...
    for i in message: #проходимся циклом по сообщению
        result=int(ord(i))+step #записываем в переменную result наше сообшение преобразрванное в целые числа с помощью ord и отнимаем шаг шифровки
